...
<c:import url="/WEB-INF/views/layout/app.jsp">
    <c:param name="content">
        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td><fmt:formatDate value='${reportDay}'
                ...
                <tr>
                    ...
                    <fmt:parseDate value="${report.inTime}"
                        pattern="HH:mm" var="inTime" type="time" />
                    <td><fmt:formatDate value='${inTime}'
                            pattern='HH:mm' /></td>
                </tr>
                <tr>
                    <th>退勤時間</th>
                ...
                <tr>
                    ...
                    <fmt:parseDate value="${report.createdAt}"
                        pattern="yyyy-MM-dd'T'HH:mm:ss" var="createDay"
                        type="date" />
                ...
                <tr>
                    ...
                    <fmt:parseDate value="${report.updatedAt}"
                        pattern="yyyy-MM-dd'T'HH:mm:ss" var="updateDay"
                        type="date" />
        ...
        <p>
            <a
                href="<c:url value='?action=${actRep}&command=${commIdx}' />">一覧に戻る</a>
        </p>
    </c:param>
</c:import>